    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_TOP->varInsert("addr", &(TOP.addr), false, VLVT_UINT32, VLVD_IN|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_TOP->varInsert("clk", &(TOP.clk), false, VLVT_UINT8, VLVD_IN|VLVF_PUB_RW, 0, 0);
    __Vscopep_TOP->varInsert("r_data", &(TOP.r_data), false, VLVT_UINT32, VLVD_OUT|VLVF_PUB_RW, 0, 1 ,31,0);
    ...
    __Vscopep_memory->varInsert("addr", &(TOP.memory__DOT__addr), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    ...
    __Vscopep_memory->varInsert("r_data", &(TOP.memory__DOT__r_data), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_memory->varInsert("rst_n", &(TOP.memory__DOT__rst_n), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
    __Vscopep_memory->varInsert("w_data", &(TOP.memory__DOT__w_data), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_memory->varInsert("w_en", &(TOP.memory__DOT__w_en), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
